...
// Create Route { route_name, title, activity_type, cover_image, description, difficulty, distance, time, location, map_data} => {route}
router.post('/create', authToken, createRoute);

// Update Route { route_name, title, activity_type, cover_image, description, difficulty, distance, time, location, map_data} => {route}
